...
files <- list.files("C:/Users/JINIL AMIN/Downloads/state-of-the-union-corpus-1989-2017")
head(files)
...
GetSentiment <- function(file)
  {
  # get the file
  fileName <- glue("C:/Users/JINIL AMIN/Downloads/state-of-the-union-corpus-1989-2017/", file, sep = "")
